...
mo:
	...
	msgfmt -c -o data/locales/ru/LC_MESSAGES/Project_Test_APP.mo data/locales/po/ru.po
	msgfmt -c -o data/locales/en/LC_MESSAGES/Project_Test_APP.mo data/locales/po/en.po
