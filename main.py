...
NICK_NAME_AND_NAME_REPOSITORY = 'https://github.com/flytrue/testapp'
...
def main():
    ...
    try:
        ...
        from project_test_app import Project_Test_APP  # основной класс программы

        # Запуск приложения.
        app = Project_Test_APP()
